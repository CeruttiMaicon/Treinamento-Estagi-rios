...
2. Acesse o [Google Fonts](https://fonts.google.com/) e escolha uma ou mais fontes para usar em sua página HTML. Siga as instruções para incorporá-las ao seu arquivo CSS e aplique-as aos elementos da página.
